...
class EditPostScreen extends StatelessWidget {
  final String postId;
  EditPostScreen({super.key, required this.postId});
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Obx(
                () {
                  print('image list length ====> ${postController.uploadImageList.length}');
                  print('image url list ====> ${postController.uploadedImageUrls}');

                  print('video url ====> ${cameraController.uploadedVideoLink.value}');
                  print('video key ====> ${cameraController.uploadedVideoKey}');
                  print('video array ====> ${cameraController.videoArray}');
