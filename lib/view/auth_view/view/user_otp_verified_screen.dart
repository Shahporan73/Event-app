...
class UserOtpVerifiedScreen extends StatelessWidget {
  final String email;
  UserOtpVerifiedScreen({super.key, required this.email});
            ...
            child: Column(
              children: [
                ...
                Obx(() => controller.secondsRemaining.value == 0
                  ...
                  title: "resend_otp".tr,
                  onTap: () {
                    controller.verifyResendOtp();  // Call resend OTP function
                  },
                )
                    : Row(
