...
class SeeAllMemberDialog extends StatefulWidget {
  final List<RecommendedUser> members;
  SeeAllMemberDialog({super.key, required this.members});

  @override
  _SeeAllMemberDialogState createState() => _SeeAllMemberDialogState();
}

class _SeeAllMemberDialogState extends State<SeeAllMemberDialog> {
  late TextEditingController _searchController;
  List<RecommendedUser> filteredMembers = [];
...
Future<void> showSeeAllMemberDialog(BuildContext context, List<RecommendedUser> members) async {
  return showDialog(
    context: context,
    barrierDismissible: true,
    builder: (BuildContext context) {
      return SeeAllMemberDialog(members: members);
    },
  );
}
